export function LoadingReg() {
  return (
    <div className="animate-pulse flex flex-col bg-bgcard border-2 rounded-3xl shadow-lg max-w-2xl w-[100vw]">
...
export function LoadingLong() {
  return (
    <div className="animate-pulse flex flex-col lg:flex-row bg-bgcard border-2 rounded-3xl shadow-lg w-[90vw]">
